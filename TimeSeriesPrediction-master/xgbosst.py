...
# cast_log_outliers('lstm-ptb-data/raw_data.txt')
# imputation_prepare('lstm-ptb-data/raw_data.txt', 'lstm-ptb-data/pre_training.txt')
imputation_with_spline('lstm-ptb-data/pre_training.txt', 'lstm-ptb-data/com_training.txt')
create_feature('lstm-ptb-data/com_training.txt', 'lstm-ptb-data/training.txt', lagging=lagging)
# add_links_lagging('lstm-ptb-data/training.txt', 'lstm-ptb-data/training1.txt')

df = pd.read_csv('lstm-ptb-data/training.txt', delimiter=';', parse_dates=['time_interval_begin'], dtype={'link_ID': object})
